...
import { CheckCircle, AlertCircle, Mail, Clock, X } from 'lucide-react';
    ...
    <AnimatePresence>
      {isOpen && (
        <Dialog open={isOpen} onOpenChange={handleClose}>
          <DialogContent className="max-w-sm sm:max-w-md mx-auto bg-black/95 border text-white overflow-hidden">
            <motion.div
